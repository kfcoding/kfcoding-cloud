package com.cuiyun.kfcoding.workspace.config;
...
import com.cuiyun.kfcoding.workspace.datasource.DruidProperties;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.cuiyun.kfcoding.workspace.dao"})
